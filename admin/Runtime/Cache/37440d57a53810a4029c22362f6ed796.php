...
<div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          	<li><a href="<?php echo U('Webconfig/index');?>" target="main">基本信息</a></li>	
			<li><a href="<?php echo U('Webconfig/advanced');?>" target="main">高级配置</a></li>	
			<li><a href="<?php echo U('Webconfig/background');?>" target="main">网页背景</a></li>	
	  ...
	  <h3 class="type"><a href="javascript:void(0)">类别管理</a></h3>
      <div class="content">
		<div style="background:url(__PUBLIC__/admin/adminImages/menu_topline.gif); width:182px; height:5px; overflow:hidden"></div>
        <ul class="MM">
			<li><a href="<?php echo U('Category/index');?>" target="main">首页列表</a></li>
			<li><a href="<?php echo U('Category/addCate');?>" target="main">添加分类</a></li>
        </ul>
	  </div>
 
	  <h3 class="type"><a href="javascript:void(0)">产品管理</a></h3>
      <div class="content">
		<div style="background:url(__PUBLIC__/admin/adminImages/menu_topline.gif); width:182px; height:5px; overflow:hidden"></div>
        <ul class="MM">
          <li><a href="<?php echo U('Product/index');?>" target="main">产品列表</a></li>
		   <li><a href="<?php echo U('Product/addProduct');?>" target="main">添加产品</a></li>
        </ul>
	  </div>
	
	  <h3 class="type"><a href="javascript:void(0)">价格管理</a></h3>
      <div class="content">
		<div style="background:url(__PUBLIC__/admin/adminImages/menu_topline.gif); width:182px; height:5px; overflow:hidden"></div>
        <ul class="MM">
          <li><a href="<?php echo U('Price/index');?>" target="main">查看价格</a></li>
          <li><a href="<?php echo U('Price/addPrice');?>" target="main">添加价格</a></li>
        </ul>
	  </div>
