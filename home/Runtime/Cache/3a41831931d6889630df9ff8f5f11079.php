...
<body>
   <div class="formdiv">
	  <form  enctype="multipart/form-data" class="inform" action="__URL__/../Admin/AddProduct" method="post">
		<p>
		...
		<p>
			...
			<select name="cname">
			   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["category_name"]); ?>">
